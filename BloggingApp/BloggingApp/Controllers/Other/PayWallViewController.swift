...
class PayWallViewController: UIViewController {
    ...
    private let termsView: UITextView = {
        ...
        textView.text = "This is an auto-renewable Subscription. It will be charged to your iTunes account before each pay period. You can cancel anytime by going into your Settings > Subscription. Restore purchases if previously subscribed."
        return textView
    }()
